  ...
  "Home": {
    ...
    "Image3": {
      "custom": {
        ...
        "src": "/app-assets/my_app_person.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Carousel1": {
      "custom": {
        ...
        "startTile": 1,
        "imageItems": [
          "/app-assets/getImg.png",
          "/app-assets/getImg2.png",
          "/app-assets/getImg3.png"
        ]
      },
      "callbacks": {
        "onClick": [
    ...
    "Image27": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/invertedComma.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox125": {
      "custom": {
        "text": "© All rights reserved. Conversionflow. Powered by Webflow / Image License Info / Instructions / Changelog / Style Guide/Archit Sharma"
      },
      "callbacks": {
        "onClick": [
          {
